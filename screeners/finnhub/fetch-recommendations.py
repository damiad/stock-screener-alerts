...
for index, row in tickers_df.iterrows():
    ...
    if recommendations:
        for recommendation in recommendations:
            ...
            recommendation_df = recommendation_df[['symbol', 'queriedSymbol', 'period', 'strongBuy', 'buy', 'hold', 'sell', 'strongSell']]
            recommendation_df.to_csv(recommendations_file, mode='a', header=not os.path.exists(recommendations_file), index=False)
